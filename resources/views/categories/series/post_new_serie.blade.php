        ...
        <form action="{{ action('SeriesController@store') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <select name="category_id" class="form-control">
                <option value="{{ '1' }}">Fumetto Americano</option>
                <option value="{{ '2' }}">Fumetto Inglese</option>
                <option value="{{ '3' }}">Fumetto Italiano</option>
          ...
          <a href="{{ action('SeriesController@index') }}" class="btn btn-secondary">Back</a>
        </form>
      </div>
    </div>
  </div>
