    ...
    <div class="card col-lg-4 offset-lg-4">
      @foreach($categories as $category)
        <div class="card-body text-center">
          ...
          <a href="{{ action('CategoriesController@edit', $category->id)}}" class="btn btn-warning mt-4 mr-4" method="POST">Edit</a>
          <a href="{{ action('CategoriesController@index') }}" class="btn btn-secondary mt-4 ml-4">Back</a>
        </div>
      @endforeach
    </div>
  </div>
